...
func ProvideAdminHandlers(
	...
	cpaImportHandler *admin.CPAImportHandler,
) *AdminHandlers {
...
func ProvideHandlers(
	...
	openAIWebThreadHandler *OpenAIWebThreadHandler,
