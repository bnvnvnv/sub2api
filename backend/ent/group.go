...
// was not loaded in eager-loading.
func (e GroupEdges) OpenaiWebThreadsOrErr() ([]*OpenAIWebThread, error) {
	if e.loadedTypes[3] {
...
// QueryOpenaiWebThreads queries the "openai_web_threads" edge of the Group entity.
func (_m *Group) QueryOpenaiWebThreads() *OpenAIWebThreadQuery {
	return NewGroupClient(_m.config).QueryOpenaiWebThreads(_m)
}
