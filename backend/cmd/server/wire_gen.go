...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIWebThreadRepository := repository.NewOpenAIWebThreadRepository(client, db)
	openAIWebThreadService := service.NewOpenAIWebThreadService(openAIWebThreadRepository, apiKeyService, subscriptionService, apiKeyRepository, accountRepository, openAIGatewayService, openAIGatewayService)
	openAIWebThreadHandler := handler.NewOpenAIWebThreadHandler(openAIWebThreadService)
	...
	proxySubscriptionHandler := admin.NewProxySubscriptionHandler()
	...
	cpaImportHandler := admin.NewCPAImportHandler(cpaImportService)
	complianceHandler := admin.NewComplianceHandler(settingService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, proxySubscriptionHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler, cpaImportHandler, complianceHandler)
