export default {
  ...
  openAIWeb: {
    title: 'ChatGPT',
    description: 'Pick a previous conversation or start a new chat.',
    ...
    createUnavailableDesc: 'No account is available right now, so a new chat cannot be started yet.',
    newChat: 'New chat',
    newChatTitle: 'New chat',
    newChatDesc: 'Start with any message.',
    newChatIntro: 'Ask anything, or ask the model to create an image.',
    newChatBadge: 'New chat',
    historyThreadBadge: 'History',
    historyTitle: 'History',
    historyEmptyTitle: 'No chat history yet',
    historyEmptyDesc: 'Your first message will automatically create a conversation here.',
    ...
    emptyChatDesc: 'Continue with {model}.',
    ...
    composerPlaceholder: 'Message ChatGPT',
    ...
    noMatchingGroupForModel: 'There is no available group for model {model} right now.',
    send: 'Send',
    sending: 'Sending...',
    userLabel: 'You',
