export default {
  ...
  openAIWeb: {
    ...
    description: 'Minimal page-level management for web sessions. This MVP only manages entitlements, thread binding, and sticky-session ownership, without changing the existing API or Codex forwarding flow.',
    ...
    scopeTitle: 'This page manages threads first',
    scopeDesc: 'The current phase exposes entitlement detection, thread creation, and archive operations. The actual chat panel will reuse these thread records later.',
    noEligibleTitle: 'No eligible OpenAI Web access',
    noEligibleDesc: 'You need at least one active OpenAI subscription group with an OAuth account that can be used for web sessions.',
    createTitle: 'Create Web Thread',
    createDesc: 'New threads are scoped to the current user and reuse the existing group scheduler plus sticky-session selection logic.',
    refresh: 'Refresh',
    ...
    threadListDesc: 'Each thread is isolated per user and bound to one upstream account plus page session.',
    emptyTitle: 'No threads yet',
    emptyDesc: 'Create a thread first. The later chat UI will reuse the same binding data.',
    groupInfo: 'Group',
    accountInfo: 'Account',
