export default {
  ...
  openAIWeb: {
    title: 'OpenAI Web Threads',
    description: 'A page-level OpenAI Web workspace for thread ownership, sticky-session routing, and metadata inspection. It keeps the current API and Codex forwarding chain unchanged while making web sessions manageable.',
    summaryBadge: 'Page-Level MVP',
    eligibleGroups: 'Eligible Groups',
    activeThreads: 'Active Threads',
    proReadyGroups: 'Pro-Ready Groups',
    privacyTitle: 'Server stores metadata only',
    privacyDesc: 'This MVP keeps only thread metadata, upstream conversation binding, and scheduler ownership on the server. Message bodies are intended to stay in browser-local cache later.',
    scopeTitle: 'Workspace first, forwarding unchanged',
    scopeDesc: 'This page reuses the existing sticky-session scheduler and account selection logic. It upgrades the user-side workspace without changing your current relay chain.',
    noEligibleTitle: 'No eligible OpenAI Web access',
    noEligibleDesc: 'You need at least one accessible OpenAI group with a usable OAuth web account. Public standard groups now count too; subscription groups still require an active subscription.',
    createTitle: 'Create Web Thread',
    createDesc: 'New threads stay isolated per user and reuse the current group scheduler plus sticky-session selection logic.',
    createUnavailableTitle: 'Creation currently unavailable',
    createUnavailableDesc: 'You can still inspect existing thread metadata here, but there is no OpenAI Web group currently available for creating new threads.',
    refresh: 'Refresh',
    groupLabel: 'Eligible Group',
    noGroupDesc: 'No group description',
    defaultModelTag: 'Default model {model}',
    proAccountsTag: 'Pro-capable accounts',
    subscriptionEndTag: 'Expires {date}',
    titleLabel: 'Thread Title',
    titlePlaceholder: 'For example: Product planning / Prompt draft',
    modelLabel: 'Requested Model',
    modelAuto: 'Use default model automatically',
    cachePolicyLabel: 'Cache Policy',
    cachePolicyHint: 'Thread metadata always stays on the server. Message bodies currently stay in this browser only. The encrypted cache mode is reserved for a later browser-side encryption implementation.',
    createButton: 'Create Thread',
    creating: 'Creating...',
    threadListTitle: 'Existing Threads',
    threadListDesc: 'Search, filter, and inspect the thread records already bound to your account pool.',
    searchPlaceholder: 'Search by title, group, model, account, or thread id',
    filterAll: 'All',
    filterReady: 'Stable',
    filterAttention: 'Attention',
    emptyTitle: 'No threads yet',
    emptyDesc: 'Create a thread first. The workspace will reuse the same binding data when the full web chat panel lands.',
    emptySearchTitle: 'No matching threads',
    emptySearchDesc: 'Adjust the search term or filter to show more thread records.',
    selectedThreadBadge: 'Current Thread',
    selectedThreadDesc: 'This panel shows the bound upstream session metadata, scheduler state, and storage policy for the selected thread.',
    selectThreadTitle: 'Select a thread',
    selectThreadDesc: 'Pick a thread from the left side to inspect routing details, upstream identifiers, and sticky-session state.',
    groupInfo: 'Group',
    accountInfo: 'Account',
    planInfo: 'Account Plan',
    providerInfo: 'Provider',
    syncStatusInfo: 'Sync Status',
    historyModeInfo: 'History Mode',
    cachePolicyInfo: 'Cache Policy',
    capabilityInfo: 'Capability',
    threadMetaTitle: 'Thread Metadata',
    sessionIdentifiersTitle: 'Session Identifiers',
    localThreadId: 'Local Thread ID',
    pageSessionId: 'Page Session ID',
    upstreamConversationId: 'Upstream Conversation ID',
    upstreamSessionId: 'Upstream Parent Message ID',
    pendingBinding: 'Waiting for upstream binding',
    copyLocalId: 'Copy Local ID',
    ...
    modelAutoResolved: 'Resolved by default model',
    threadNeedsAttention: 'Needs attention',
    sessionCanvasTitle: 'Session Canvas',
    sessionCanvasDesc: 'The current backend does not expose full message bodies yet, so this canvas focuses on the thread state that already exists today.',
    sessionSystemBubble: 'This thread is pinned to group {group} and currently requests model {model}.',
    sessionStorageBubble: 'Only metadata, sticky-session ownership, and upstream identifiers are stored server-side. Message bodies are intended to remain in browser-local cache or upstream web history later.',
    sessionPendingBubble: 'The upstream conversation has not been materialized yet. It will be filled once the web-side chat flow binds a real upstream session.',
    sessionBoundBubble: 'Upstream conversation is already bound: {id}',
    chatTitle: 'Chat Panel',
    chatDesc: 'Messages are cached in this browser only, while server-side billing and upstream session routing stay on the existing pipeline.',
    messageCount: '{count} messages',
    emptyChatTitle: 'Start the first turn',
    emptyChatDesc: 'This thread belongs to {group} and will use {model}. Send a first message to bind the upstream web session and start local browser caching.',
    chatModelLabel: 'Chat Model',
    reasoningEffortLabel: 'Reasoning Effort',
    reasoningEffortAuto: 'Follow default',
    chatBillingHint: 'This thread is billed through your existing usage system.',
    composerPlaceholder: 'Send text here and optionally attach images. Press Enter to send, Shift+Enter for a new line.',
    composerHint: 'You can send mixed text and image prompts. Model switches become the thread default, while reasoning effort stays in this browser and will not sync across devices.',
    addImages: 'Add Images',
    clearImages: 'Clear Images',
    removeImage: 'Remove',
    imageAttachment: 'Image attachment',
    imageCountTag: '{count} image(s)',
    attachmentLimitReached: 'You can attach up to {count} images.',
    attachmentTypeInvalid: 'Only image files are supported.',
    attachmentTooLarge: 'Each image must be smaller than {size}.',
    attachmentReadFailed: 'Failed to read the image. Please try again.',
    send: 'Send',
    sending: 'Sending...',
    userLabel: 'You',
    assistantLabel: 'Assistant',
    pendingReply: 'Waiting for upstream reply...',
    failedReply: 'This turn failed',
    emptyAssistantReply: 'Upstream returned an empty reply.',
    assistantImageAlt: 'Generated image',
    previewImage: 'Preview',
    downloadImage: 'Download',
    imageDimensionsTag: '{width}×{height}',
    requestIdTag: 'Request {id}',
    responseIdTag: 'Response {id}',
    usageTag: 'In {input} · Out {output} · Total {total}',
    localCacheImageWarning: 'Browser storage is full. Text messages were kept, but generated images will not persist after refresh.',
    localCacheDisabledWarning: 'Browser storage write failed. Messages are only kept in page memory for this session.',
    timelineTitle: 'Timeline',
    timelineCreated: 'Thread created',
    timelineUpdated: 'Last updated',
    timelineSynced: 'Last sync snapshot',
    timelineCacheMode: 'Local cache mode',
    timelineNotSynced: 'No sync snapshot yet',
    failedToLoad: 'Failed to load OpenAI Web data',
    createSuccess: 'Thread created',
    createFailed: 'Failed to create thread',
    archiveSuccess: 'Thread archived',
    archiveFailed: 'Failed to archive thread',
    ...
    capability: {
      web_chat: 'Standard web chat',
      pro_model: 'Pro model capability'
    },
    reasoningEffort: {
      low: 'Low',
      medium: 'Medium',
    ...
    historyMode: {
      ...
      hybrid: 'Hybrid',
      server_mirror: 'Server mirror'
    },
    cachePolicy: {
      local_only: 'Browser-local only',
      local_encrypted: 'Browser-local (encryption pending)'
    },
    accessMode: {
      standard: 'Public standard access',
