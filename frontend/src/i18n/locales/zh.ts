export default {
  ...
  openAIWeb: {
    ...
    createUnavailableDesc: '当前暂无可用账号，暂时无法开始新的聊天。',
    newChat: '新聊天',
    newChatTitle: '新的聊天',
    newChatDesc: '输入消息即可开始。',
    newChatIntro: '问点什么，或者让模型帮你生成一张图片。',
    newChatBadge: '新聊天',
    historyThreadBadge: '历史会话',
    historyTitle: '聊天记录',
    historyEmptyTitle: '还没有聊天记录',
    historyEmptyDesc: '发送第一条消息后，这里会自动出现新的会话。',
    ...
    noMatchingGroupForModel: '当前没有可用于模型 {model} 的可用分组。',
    send: '发送',
    sending: '发送中...',
    userLabel: '你',
    assistantLabel: '助手',
