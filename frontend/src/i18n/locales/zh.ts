export default {
  ...
  redeem: {
    ...
    subscriptionQuotaAdded: '订阅临时额度已添加',
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaTarget: "请选择要为 '{user}' 重置的用量周期。所选周期会归零并从今天开始重新计算。",
      resetQuotaDaily: '当天用量',
      resetQuotaDailyDesc: '重置每日窗口的已用额度',
      resetQuotaWeekly: '当周用量',
      resetQuotaWeeklyDesc: '重置每周窗口的已用额度',
      resetQuotaMonthly: '当月用量',
      resetQuotaMonthlyDesc: '重置每月窗口的已用额度',
      resetQuotaSelectAtLeastOne: '请至少选择一个要重置的周期',
    ...
    redeem: {
      ...
      quotaAmount: '临时额度 ($)',
      quotaPeriod: '额度周期',
      quotaAmountRequired: '临时额度必须大于 0',
      codeExpiry: '兑换码过期',
      neverExpires: '永不过期',
